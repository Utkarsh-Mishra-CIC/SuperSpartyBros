...
public class CharacterController2D : MonoBehaviour {
	...
	void Update()
	{
		...
		{
            DoJump();
		} else if(_canDoubleJump && CrossPlatformInputManager.GetButtonDown("Jump")) // if can doublejump and jump button is pressed, then allow player to double jump
        {
            DoJump();
            // disable double jump after doublejumping since you can only double jump once
